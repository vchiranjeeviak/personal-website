...
Where AI starts to make sense is when you're not sure what needs to change, where it needs to change, or when the change is large. Exploring unfamiliar codebases, building out new features, or figuring out how an API works — these are areas where AI can genuinely help. But even here, there are two problems.
